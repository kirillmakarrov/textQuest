...
public class GameList {
    ...
    public static void game(GameObject object) {
        ...
        if (choose == 1) GameList.game(GameList.gameList[object.getFirstNode()]);
        else if (choose == 2) GameList.game(GameList.gameList[object.getSecondNode()]);
